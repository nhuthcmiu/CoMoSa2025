...
<meta charset=utf-8>
<title>COMOSA2025</title>
<meta name=description content="COMOSA2025">
<meta name=keywords content="COMOSA2025"/>
<meta name=author content="Nhut Nguyen">
...
<script>(function(d,e,j,h,f,c,b){d.GoogleAnalyticsObject=f;d[f]=d[f]||function(){(d[f].q=d[f].q||[]).push(arguments)},d[f].l=1*new Date();c=e.createElement(j),b=e.getElementsByTagName(j)[0];c.async=1;c.src=h;b.parentNode.insertBefore(c,b)})(window,document,"script","//www.google-analytics.com/analytics.js","ga");ga("create","UA-60320176-1","auto");ga("send","pageview");</script>
<meta name=msvalidate.01 content=BA0BBC58CBEE9FCB03BD66E27D9252B5 />
<body>
<header>
...
<div class="wrap">
  <div class="tc">
   ...
   <h3>Conference on Optimization, Modeling, Simulation, and Analytics (COMOSA 2025)</h3>
  <h4>The 5th Season of the VORN Annual Meeting</h4>
  <p><strong>Date:</strong> August 15–16, 2025 | <strong>Location:</strong> VinUniversity, Hanoi, Vietnam</p>

  <p><strong>COMOSA 2025</strong>, formerly known as VORN (Vietnam Operations Research Network) Annual Meeting, provides a premier interdisciplinary forum to bring together researchers, practitioners, and students from all fields related to optimization, modeling, simulation, and analytics. The primary objective of the workshop is to foster collaboration, share insights, and explore innovative solutions to real-world problems through discussions on the latest advancements and applications in these domains.</p>
  ...
  <ul>
    <li><strong>Optimization for Supply Chain Systems</strong>
      <ul>
    ...
    <li><strong>Simulation and Modeling in Business Operations</strong>
      <ul>
    ...
    <li><strong>Optimization in Data Science and Artificial Intelligence</strong>
      <ul>
  ...
  <h4>Submission and Author Info</h4>
  <p><strong>Submission link:</strong> TBC<br>
     <strong>Author toolkit:</strong> (Include all the paper templates)</p>

  <h4>Important Dates</h4>
  <ul>
    <li><strong>Paper Submission Deadline:</strong> June 01, 2025</li>
    <li><strong>Paper Acceptance Notification:</strong> July 01, 2025</li>
    <li><strong>Early Bird Registration Deadline:</strong> TBA</li>
    <li><strong>Camera Ready Deadline:</strong> July 15, 2025</li>
    <li><strong>Author Registration Deadline:</strong> August 01, 2025</li>
    <li><strong>Conference Dates:</strong> August 15–16, 2025</li>
  </ul>
